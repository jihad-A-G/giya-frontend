    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          services: Array.isArray(project.services) && project.services.length > 0 ? project.services : [''],
          highlights: Array.isArray(project.highlights) && project.highlights.length > 0 ? project.highlights : [''],
          stats: project.stats || {},
  ...
  return (
    <div className="px-4 py-6 sm:px-0">
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-gray-600">Update the project information below</p>
      </div>
